...
* Fix scope for variables introduced by pattern expressions (PR [#4539](https://github.com/javaparser/javaparser/pull/4539) by [@johannescoetzee](https://github.com/johannescoetzee))
* Add feature of creating pretty formatted arrays of annotations (PR [#4491](https://github.com/javaparser/javaparser/pull/4491) by [@kamilkrzywanski](https://github.com/kamilkrzywanski))
* Add record resolution [continuation of PR #3606] (PR [#4489](https://github.com/javaparser/javaparser/pull/4489) by [@johannescoetzee](https://github.com/johannescoetzee))
